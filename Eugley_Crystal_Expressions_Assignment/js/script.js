...
var totalPrice2 = dogFoodPrice2 - foodDiscount2*dogFoodPrice2/100;

alert("Your total cost before tax at store 2 is "+totalPrice2);

alert ("Your before tax price at Store 1 is " + totalPrice + "Your before tax price at Store 2 is " + totalPrice2);